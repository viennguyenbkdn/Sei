...
seid tx sign $HOME/SEI_ACT4/gen_bundle_tx.json --from $wallet --chain-id atlantic-1 --output-document $HOME/SEI_ACT4/bundle_tx.json --node https://sei-testnet-rpc.brocha.in:443; sleep 10;

...
seid tx sign $HOME/SEI_ACT4/gen_limit_tx.json --from $wallet --chain-id atlantic-1 --output-document $HOME/SEI_ACT4/limit_tx.json --node https://sei-testnet-rpc.polkachu.com:443; sleep 10;
